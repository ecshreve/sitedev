...
{% include brief.html 
  ...
  link = "/overview/docker"
%}

{% include brief.html 
  tech = "Ansible"
  desc = "Provision virtual machines running Ubuntu. Maintain a variety of custom roles for common configuration tasks."
  link = "/overview/ansible"
%}
